...
enviarButton.onclick = function () {
    ...
    <button class="listaDeTarefas__tarefa--botao botao"><span class="material-icons-outlined botaoDone">done</span></button>
    <button class="listaDeTarefas__tarefa--botao botao"><span class="material-icons-outlined botaoClose">close</span></button>
    `;
